...
// Define the asset types you want to cache
const assetTypes = ["style", "script", "worker"];

// Register route for the specified asset types using StaleWhileRevalidate
registerRoute(
  ({ request }) => assetTypes.includes(request.destination),
